...
def generate_common_race_list(data: str):
  ...
  # TODO: generatedDataを出力してどの部分に「進入固定」があるか探す。
...
def create_Excel_Data_from_Local_data(columnCount: int, index: int, data:str, sheet, txtFile, datalist: list):
  indexElm = 0
  roundDict = {"着順":" ","艇番":" ","登録番号":" ","選手名":" ","オッズ":" ","体重":" ","ﾓｰﾀｰ":" ","ﾎﾞｰﾄ":" ","展示":" ","進入":" ","ST" :" ","ﾚｰｽﾀｲﾑ":" ","進入固定":" ","ラウンド":" ","コース(m)":" ","天気":" ","風向":" ","風速(m)":" ","波(cm)":" ","日付":" ","開催場所":" ","大会名":" ","SG":" ","G1":" ","G2":" ","G3":" ","一般":" "}
  fixedEnter = 0
